...
import type { Child, ParentFormData } from "../types/Parent";
        ...
        <div className="parent-form">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="address" id="address" name="address" value={formData.address} onChange={handleChange} className="form-control" />
                </div>
